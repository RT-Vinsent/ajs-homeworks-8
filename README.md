...
## Каждая задача отдельный модуль.

[![Build status](https://ci.appveyor.com/api/projects/status/k4pini6xcbkyk3o9?svg=true)](https://ci.appveyor.com/project/RT-Vinsent/ajs-homeworks-8)
